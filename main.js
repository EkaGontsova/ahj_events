...
var Goblin = /*#__PURE__*/function () {
  ...
  return Goblin_createClass(Goblin, [{
    key: "show",
...
var Game = /*#__PURE__*/function () {
  ...
  return Game_createClass(Game, [{
    ...
    value: function startGame() {
      ...
      this.goblinInterval = setInterval(function () {
        _this2.goblin.hide();
        _this2.goblin.show(_this2.board.getRandomCell());
        setTimeout(function () {
          if (_this2.goblin.isVisible) {
            _this2.goblin.hide();
            _this2.missed += 1;
            _this2.updateMisses();
      ...
      this.board.cells.forEach(function (cell) {
        cell.addEventListener("click", function () {
          if (_this2.goblin.isVisible && cell.contains(_this2.goblin.element)) {
            _this2.score += 1;
            _this2.updateHits();
            _this2.goblin.hide();
            _this2.checkGameOver();
    ...
    key: "updateHits",
    value: function updateHits() {
      this.hitsDisplay.textContent = "\u041F\u043E\u043F\u0430\u0434\u0430\u043D\u0438\u044F: ".concat(this.score);
    }
  }, {
    key: "updateMisses",
    value: function updateMisses() {
      this.missesDisplay.textContent = "\u041F\u0440\u043E\u043C\u0430\u0445\u0438: ".concat(this.missed);
    }
  }, {
    key: "checkGameOver",
    value: function checkGameOver() {
      if (this.missed >= 5) {
        clearInterval(this.goblinInterval);
        alert("\u0418\u0433\u0440\u0430 \u043E\u043A\u043E\u043D\u0447\u0435\u043D\u0430! \u0412\u0430\u0448 \u0441\u0447\u0435\u0442: ".concat(this.score));
      }
    }
  }]);
}();
